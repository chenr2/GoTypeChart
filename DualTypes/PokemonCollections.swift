...
struct PokemonCollections {
    ...
    static let legacyPidgeot = Pokemon(pokedex: 18, species: .legacyPidgeot, type: [.Normal, .Flying], quickAttacks: [.wingAttack, .steelWing], specialAttacks: [.hurricane, .aerialAce, .airCutter], stamina: 166, attack: 166, defense: 157, legacy: true)
    ...
    static let legacyParasect = Pokemon(pokedex: 47, species: .legacyParasect, type: [.Bug, .Grass], quickAttacks: [.bugBite, .furyCutter], specialAttacks: [.solarBeam, .xScissor, .crossPoison], stamina: 120, attack: 165, defense: 146, legacy: true)
    ...
    static let legacyArcanine = Pokemon(pokedex: 59, species: .legacyArcanine, type: [.Fire], quickAttacks: [.fireFang, .bite], specialAttacks: [.fireBlast, .bulldoze, .flamethrower], stamina: 180, attack: 227, defense: 166, legacy: true)
    ...
    static let legacyMachamp = Pokemon(pokedex: 68, species: .legacyMachamp, type: [.Fight], quickAttacks: [.bulletPunch, .karateChop], specialAttacks: [.crossChop, .stoneEdge, .submission], stamina: 180, attack: 234, defense: 162, legacy: true)
    ...
    static let legacyDewgong = Pokemon(pokedex: 87, species: .legacyDewgong, type: [.Water, .Ice], quickAttacks: [.frostBreath, .iceShard], specialAttacks: [.aquaJet, .icyWind, .blizzard], stamina: 180, attack: 139, defense: 184, legacy: true)
    ...
    static let legacyCloyster = Pokemon(pokedex: 91, species: .legacyCloyster, type: [.Water, .Ice], quickAttacks: [.iceShard, .frostBreath], specialAttacks: [.icyWind, .blizzard, .hydroPump], stamina: 100, attack: 186, defense: 323, legacy: true)
    ...
    static let legacyExeggutor = Pokemon(pokedex: 103, species: .legacyExeggutor, type: [.Grass, .Psychic], quickAttacks: [.confusion, .zenHeadbutt], specialAttacks: [.psychic, .seedBomb, .solarBeam], stamina: 190, attack: 233, defense: 158, legacy: true)
    ...
    static let legacyScyther = Pokemon(pokedex: 123, species: .legacyScyther, type: [.Bug, .Flying], quickAttacks: [.steelWing, .furyCutter], specialAttacks: [.bugBuzz, .xScissor, .nightSlash], stamina: 140, attack: 218, defense: 170, legacy: true)
    ...
    static let legacyJynx = Pokemon(pokedex: 124, species: .legacyJynx, type: [.Ice, .Psychic], quickAttacks: [.pound, .frostBreath], specialAttacks: [.icePunch, .psyshock, .drainingKiss], stamina: 130, attack: 223, defense: 182, legacy: true)
    ...
    static let legacyGyarados = Pokemon(pokedex: 130, species: .legacyGyarados, type: [.Water, .Flying], quickAttacks: [.bite, .dragonBreath], specialAttacks: [.twister, .hydroPump, .dragonPulse], stamina: 190, attack: 237, defense: 197, legacy: true)
    ...
    static let legacyLapras = Pokemon(pokedex: 131, species: .legacyLapras, type: [.Water, .Ice], quickAttacks: [.frostBreath, .iceShard], specialAttacks: [.dragonPulse, .iceBeam, .blizzard], stamina: 260, attack: 165, defense: 180, legacy: true)
    ...
    static let legacySnorlax = Pokemon(pokedex: 143, species: .legacySnorlax, type: [.Normal], quickAttacks: [.lick, .zenHeadbutt], specialAttacks: [.bodySlam, .hyperBeam, .earthquake], stamina: 320, attack: 190, defense: 190, legacy: true)
    ...
    static let legacyDragonite = Pokemon(pokedex: 149, species: .legacyDragonite, type: [.Dragon, .Flying], quickAttacks: [.steelWing, .dragonBreath], specialAttacks: [.hyperBeam, .dragonClaw, .dragonPulse], stamina: 182, attack: 263, defense: 201, legacy: true)
