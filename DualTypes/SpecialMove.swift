...
struct SpecialMove {
    ...
    static func moveForSpecialAttack(_ specialAttack: SpecialAttack) -> SpecialMove {
        ...
        case .flamethrower: return SpecialMove(element: .Fire, specialAttack: specialAttack, power:70, bar: 2, duration: 2200)
        case .flameWheel: return SpecialMove(element: .Fire, specialAttack: specialAttack, power:60, bar: 2, duration: 2700)
        ...
        case .iceBeam: return SpecialMove(element: .Ice, specialAttack: specialAttack, power:90, bar: 2, duration: 3300)
        ...
        case .thunderbolt: return SpecialMove(element: .Electric, specialAttack: specialAttack, power:80, bar: 2, duration: 2500)
        case .thunderPunch: return SpecialMove(element: .Electric, specialAttack: specialAttack, power:45, bar: 3, duration: 1800)
