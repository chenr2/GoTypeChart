...
class Pokemon {
    ...
    class func gymLeaders() -> [Pokemon] {
        ...
        let blastoise = Pokemon(pokedex: 9, name: "Blastoise", defense: [.Water], tier: .S)
        ...
        let raichu = Pokemon(pokedex: 26, name: "Raichu", defense: [.Electric], tier: .B)
        ...
        let nidoking = Pokemon(pokedex: 34, name: "Nidoking", defense: [.Ground, .Poison], tier: .A)
        ...
        let victreebel = Pokemon(pokedex: 71, name: "Victreebel", defense: [.Grass, .Poison], tier: .A)
        ...
        let golem = Pokemon(pokedex: 76, name: "Golem", defense: [.Ground, .Rock], tier: .S)
        ...
        let magneton = Pokemon(pokedex: 82, name: "Magneton", defense: [.Electric, .Steel], tier: .A)
        ...
        let gengar = Pokemon(pokedex: 94, name: "Gengar", defense: [.Ghost, .Poison], tier: .B)
        let onix = Pokemon(pokedex: 95, name: "Onix", defense: [.Rock, .Ground], tier: .B)
        ...
        let chansey = Pokemon(pokedex: 113, name: "Chansey", defense: [.Normal], tier: .B)
        ...
        let seaking = Pokemon(pokedex: 119, name: "Seaking", defense: [.Water], tier: .B)
        ...
        let gyarados = Pokemon(pokedex: 130, name: "Gyarados", defense: [.Flying, .Water], tier: .S)
        ...
        let omastar = Pokemon(pokedex: 139, name: "Omastar", defense: [.Rock, .Water], tier: .S)
        ...
        let aerodactyl = Pokemon(pokedex: 142, name: "Aerodactyl", defense: [.Flying, .Rock], tier: .A)
        let snorlax = Pokemon(pokedex: 143, name: "Snorlax", defense: [.Normal], tier: .S)
