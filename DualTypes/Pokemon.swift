...
class Pokemon {
    ...
    class func calculateTypeResults(_ pokemon: Pokemon, quickAttack: QuickAttack, specialAttack: SpecialAttack, dodging: Dodge, engagement: Engagement) -> [TypeResult] {
        ...
        for opponent in opponents {
            ...
            let chargeMoveDPS: CGFloat = SpecialMove.cmDPSBasedOnQm(bar: chargeMove.bar, duration: chargeMove.duration, power: chargeMove.power, quickmoveEPS: quickMove.eps)
